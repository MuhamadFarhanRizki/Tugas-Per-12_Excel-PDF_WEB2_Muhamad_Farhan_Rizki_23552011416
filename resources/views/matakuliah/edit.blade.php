...
<div class="container mt-5">
    ...
    <form action="{{ route('matakuliah.update',$data->id_matakuliah) }}" method="POST">
        @csrf
        @method('PUT')
        <input class="form-control mb-2" type="text" name="nama_matakuliah" value="{{ $data->nama_matakuliah }}">
        <input class="form-control mb-2" type="number" name="sks" value="{{ $data->sks }}">
